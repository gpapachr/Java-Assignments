...
public class Application2 {
	...
	{
		/*
			It is an empty constructor. We need it to create an object of this class
			in order to can call each non-static method we want in our main
		*/
	}
	...
	public static void main(String args[]) {
		...
		int n = sc.nextInt();
		boolean response = app.isPrime(n);
		...
		int number = app.digitsOfInteger(n);
		...
		double area = app.findArea(a, b, c);
		...
		int reversed = app.reverseDigits(n);
